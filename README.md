...
This project contains a fast, modern Retrieval Augmented Generation chatbot built with LangChain, Groq, FAISS, and Streamlit. This project supports uploading multiple documents (PDF, DOCX, TXT, MD) and asking natural language questions. The chatbot retrieves the most relevant chunks and generates accurate answers using Groq’s LLMs.
Features
